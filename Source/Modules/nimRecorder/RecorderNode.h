...
private:
	struct RecordedNodePropInfo
	{
		...
		void Reset()
		{
	        ...
	        off_t nPos;		//Position in stream of record that did this property change
	};
	...
	XnStatus UpdateNodePropInfo(const XnChar* strNodeName, const XnChar* strPropName, RecordedNodeInfo*& pRecordedNodeInfo, off_t& nUndoPos);
